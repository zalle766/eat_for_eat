...
export default function DriverSidebar({ currentView, setCurrentView, isOpen, onClose }: DriverSidebarProps) {
  const menuItems = [
  ...
  return (
    <>
      ...
      <aside
        className={`
          fixed right-0 top-16 bottom-0 w-64 bg-white border-l border-gray-200 overflow-y-auto z-40
