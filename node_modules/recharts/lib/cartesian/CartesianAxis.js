...
class CartesianAxis extends _react.Component {
  ...
  render() {
    ...
    }, axisLine && this.renderAxisLine(), this.renderTicks(this.state.fontSize, this.state.letterSpacing, ticks), /*#__PURE__*/React.createElement(_Label.CartesianLabelContextProvider, {
      x: this.props.x,
      y: this.props.y,
